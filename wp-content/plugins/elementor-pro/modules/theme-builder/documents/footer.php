						...
						<div class="copyright">
							<?php
								if (mfn_opts_get('footer-copy')) {
									...
									echo '&copy; '. esc_html(date('Y')) .' '. esc_html(get_bloginfo('name')) .'. All Rights Reserved. <a target="_blank" rel="nofollow" href="https://muffingroup.com"><img src="http://localhost/cyb3rt0wn/wp-content/uploads/2021/03/iliauni-logo-white-1.png"></a>';
								}
							?>
						</div>
